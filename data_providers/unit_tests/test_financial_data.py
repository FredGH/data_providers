...
class TestFinancialData(unittest.TestCase):
    ...
    def test_get_calendar_positive(self):
        # Arrange
        expected_calendar = pd.DataFrame({'date': ['2023-01-01'], 'event': ['Earnings']})
    ...
    def test_get_shares_full_positive(self):
        ...
        # Act
        result = self.financial_data.get_get_shares_full(start="2022-01-01", end="2023-01-01")
    ...
    def test_get_shares_full_negative(self):
        # Arrange
        self.mock_ticker_data.get_shares_full.side_effect = Exception("Error fetching shares")
        
        # Act & Assert
        with self.assertRaises(Exception):
            _ = self.financial_data.get_get_shares_full(start="2022-01-01", end="2023-01-01")
